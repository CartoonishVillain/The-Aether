...
public class AetherPlayerRankings
{
    ...
    public static class Registration
    {
        ...
        public static void registerRanks(RankingEvent event) {
            event.addRank("13655ac1-584d-4785-b227-650308195121", PlayerRanking.GILDED_GAMES); //Brandon Pearce; kingbdogz
            ...
            event.addRank("c0643897-c500-4f61-a62a-8051801562a9", PlayerRanking.GILDED_GAMES); //Christian Peterson; Raetro
            ...
            event.addRank("ffb94179-dd54-400d-9ece-834720cd7be9", PlayerRanking.RETIRED_GILDED_GAMES); //Angeline; JellySquid
            event.addRank("68fef942-0c9f-45b9-8b72-6d94a7d08b8e", PlayerRanking.RETIRED_GILDED_GAMES); //Chelsea

            event.addRank("1d680bb6-2a9a-4f25-bf2f-a1af74361d69", PlayerRanking.MODDING_LEGACY); //Bailey; Phygie
